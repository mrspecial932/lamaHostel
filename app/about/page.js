    ...
    return (
      ...
      <div className="grid grid-cols-5 gap-x-24 gap-y-32 text-lg items-center">
        <div className="col-span-3">
          ...
          <div className="space-y-8">
            ...
            <p>
              ...
              splendor. It's a place to slow down, r elax, and feel the joy of
        ...
        <div className="col-span-2 aspect-square relative">
          <Image
            src={about} fill placeholder="blur"
            alt="Family sitting around a fire pit in front of cabin"
          />
        </div>
  
        <div className="col-span-2 aspect-square relative">
          <Image src={about1} fill  placeholder="blur"  alt="Family that manages The Wild Oasis" />
        </div>
